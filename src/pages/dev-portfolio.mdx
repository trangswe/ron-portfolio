...
### Markdown magic
All contents are written with Markdown (like this post you're reading!). And things load fast (enough). My TODO is to make things load faster and have better Lighthouse score. It's okay for now though.
